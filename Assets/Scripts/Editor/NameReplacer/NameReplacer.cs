...
public class NameReplacer : EditorWindow
{
    ...
    List<UnityEngine.Object> retrievedAssets = new List<UnityEngine.Object>();
    ...
    private void OnGUI()
    {
        ...
        respectUppercases = EditorGUILayout.ToggleLeft("Respect Uppercases", strictSearch);
        ...
        if (Strings.AreNoneNullOrEmptyOrWhiteSpace(select) && retrievedAssets.Count > 0)
        {
    ...
    void OnWizardCreate()
    {
        ...
        if (Strings.AreAnyNullOrEmptyOrWhiteSpace(searchedAssetName))
        {
            return;
        }
        ...
        for (int i = 0; i < allAssetsPathsInProject.Length; i++)
        {
            ...
            Object currentAsset = AssetDatabase.LoadAssetAtPath(path, typeof(Object));
    ...
    private void DisplayHelpBoxes()
    {
        ...
        if (Strings.AreAnyNullOrEmptyOrWhiteSpace(select) && retrievedAssets.Count > 0 && hasPressedSearchButton)
        {
